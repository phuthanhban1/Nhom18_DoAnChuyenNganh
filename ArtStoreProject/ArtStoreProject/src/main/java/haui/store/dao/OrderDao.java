...
import haui.store.model.StatisticalOrder;
...
//	@Query("SELECT new StatisticalProductDay(o.product.code, o.product.name, o.product.price, o.product.quantity, sum(o.quality)) FROM Order o WHERE CAST(GETDATE() as date) = o.date GROUP BY o.product.code, o.product.name, o.product.price, o.product.quality")
//	List<StatisticalProductDay> listStatisticalProductDay();

	@Query("SELECT new StatisticalProductDay(o.product.code, o.product.name, o.product.price, o.product.quantity, sum(o.quality)) " +
			"FROM Order o WHERE CURRENT_DATE() = o.date " +
			"GROUP BY o.product.code, o.product.name, o.product.price, o.product.quantity")
	List<StatisticalProductDay> listStatisticalProductDay();
