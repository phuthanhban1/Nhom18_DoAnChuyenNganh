...
public class ProductServiceImp implements ProductService {
	...
	public ProductModel createProduct(ProductModel productModel) {
		...
		product.setMenu1_Id(productModel.getMenu1Id());
		product.setMenu2_Id(productModel.getMenu2Id());
	...
	public ProductModel getOneProductById(Integer id) {
		...
		productModel.setMenu1Id(product.getMenu1_Id());
		productModel.setMenu2Id(product.getMenu2_Id());
		return productModel;
	}
